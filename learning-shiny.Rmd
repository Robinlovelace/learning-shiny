...
To avoid simply duplicating past work this
tutorial builds on and creates a narrative for
the excellent [RStudio tutorial](http://shiny.rstudio.com/tutorial/),
rather than trying to 
rebuild the wheel. The aim is simple: **to navigate beginners through the basics of shiny for creating interactive online visualisations**. 
